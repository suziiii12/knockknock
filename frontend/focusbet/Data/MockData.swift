...
enum MockData {
    ...
    private static let fallbackFloorPlan = BuildingFloorPlan(points: [
        (0.10, 0.10), (0.90, 0.10), (0.90, 0.90), (0.10, 0.90),
    ])

    private static func floorPlan(_ key: String) -> BuildingFloorPlan {
        floorPlans[key] ?? fallbackFloorPlan
    }
    ...
    static let buildings: [Building] = [
        Building(id: "walc",     name: "Wilmeth Active Learning Center",       abbreviation: "WALC",  position: BuildingPosition(x: 32, y: 32), kingUserId: nil, kingName: nil, totalScore: 0, sessionsCount: 0, colorIndex: 0, floorPlan: floorPlan("walc"),     latitude: 40.427404, longitude: -86.913219),
        Building(id: "lawson",   name: "Lawson Computer Science Building",      abbreviation: "LWSN",  position: BuildingPosition(x: 14, y: 32), kingUserId: nil, kingName: nil, totalScore: 0, sessionsCount: 0, colorIndex: 1, floorPlan: floorPlan("lawson"),   latitude: 40.427787, longitude: -86.917025),
        Building(id: "hicks",    name: "Hicks Undergraduate Library",           abbreviation: "HIKS",  position: BuildingPosition(x: 56, y: 42), kingUserId: nil, kingName: nil, totalScore: 0, sessionsCount: 0, colorIndex: 2, floorPlan: floorPlan("hicks"),    latitude: 40.424533, longitude: -86.912658),
        Building(id: "haas",     name: "Felix Haas Hall",                       abbreviation: "HAAS",  position: BuildingPosition(x: 56, y: 32), kingUserId: nil, kingName: nil, totalScore: 0, sessionsCount: 0, colorIndex: 3, floorPlan: floorPlan("haas"),     latitude: 40.426827, longitude: -86.916340),
        Building(id: "knoy",     name: "Knoy Hall of Technology",               abbreviation: "KNOY",  position: BuildingPosition(x: 32, y: 18), kingUserId: nil, kingName: nil, totalScore: 0, sessionsCount: 0, colorIndex: 4, floorPlan: floorPlan("knoy"),     latitude: 40.427754, longitude: -86.911131),
        Building(id: "pmu",      name: "Purdue Memorial Union",                 abbreviation: "PMU",   position: BuildingPosition(x: 38, y: 48), kingUserId: nil, kingName: nil, totalScore: 0, sessionsCount: 0, colorIndex: 5, floorPlan: floorPlan("pmu"),      latitude: 40.424975, longitude: -86.911285),
        Building(id: "hovde",    name: "Hovde Hall of Administration",          abbreviation: "HOVD",  position: BuildingPosition(x: 32, y: 46), kingUserId: nil, kingName: nil, totalScore: 0, sessionsCount: 0, colorIndex: 6, floorPlan: floorPlan("hovde"),    latitude: 40.428241, longitude: -86.914432),
        Building(id: "corec",    name: "Córdova Recreational Sports Center",    abbreviation: "COREC", position: BuildingPosition(x: 10, y: 80), kingUserId: nil, kingName: nil, totalScore: 0, sessionsCount: 0, colorIndex: 7, floorPlan: floorPlan("corec"),    latitude: 40.428500, longitude: -86.922400),
        Building(id: "lilly",    name: "Lilly Hall of Life Sciences",           abbreviation: "LILY",  position: BuildingPosition(x: 16, y: 62), kingUserId: nil, kingName: nil, totalScore: 0, sessionsCount: 0, colorIndex: 8, floorPlan: floorPlan("lilly"),    latitude: 40.423395, longitude: -86.918161),
        Building(id: "krach",    name: "Krach Leadership Center",               abbreviation: "KRCH",  position: BuildingPosition(x: 70, y: 32), kingUserId: nil, kingName: nil, totalScore: 0, sessionsCount: 0, colorIndex: 9, floorPlan: floorPlan("krach"),    latitude: 40.427580, longitude: -86.921270),
        Building(id: "heavilon", name: "Heavilon Hall",                         abbreviation: "HEAV",  position: BuildingPosition(x: 72, y: 44), kingUserId: nil, kingName: nil, totalScore: 0, sessionsCount: 0, colorIndex: 0, floorPlan: floorPlan("heavilon"), latitude: 40.425800, longitude: -86.913800),
        Building(id: "stanley",  name: "Stanley Coulter Hall",                  abbreviation: "SC",    position: BuildingPosition(x: 40, y: 62), kingUserId: nil, kingName: nil, totalScore: 0, sessionsCount: 0, colorIndex: 1, floorPlan: floorPlan("stanley"),  latitude: 40.426530, longitude: -86.914379),
        Building(id: "rec",      name: "Recitation Building",                   abbreviation: "REC",   position: BuildingPosition(x: 56, y: 62), kingUserId: nil, kingName: nil, totalScore: 0, sessionsCount: 0, colorIndex: 2, floorPlan: floorPlan("rec"),      latitude: 40.427000, longitude: -86.913900),
        Building(id: "krannert", name: "Krannert Building",                     abbreviation: "KRAN",  position: BuildingPosition(x: 80, y: 62), kingUserId: nil, kingName: nil, totalScore: 0, sessionsCount: 0, colorIndex: 3, floorPlan: floorPlan("krannert"), latitude: 40.423693, longitude: -86.910956),
        Building(id: "stewart",  name: "Stewart Center",                        abbreviation: "STEW",  position: BuildingPosition(x: 38, y: 55), kingUserId: nil, kingName: nil, totalScore: 0, sessionsCount: 0, colorIndex: 4, floorPlan: floorPlan("stewart"),  latitude: 40.425052, longitude: -86.912749),
        Building(id: "ee",       name: "Materials & Electrical Engineering",    abbreviation: "MSEE",  position: BuildingPosition(x: 50, y: 18), kingUserId: nil, kingName: nil, totalScore: 0, sessionsCount: 0, colorIndex: 5, floorPlan: floorPlan("ee"),       latitude: 40.429345, longitude: -86.912669),
        Building(id: "arms",     name: "Neil Armstrong Hall of Engineering",    abbreviation: "ARMS",  position: BuildingPosition(x: 60, y: 35), kingUserId: nil, kingName: nil, totalScore: 0, sessionsCount: 0, colorIndex: 6, floorPlan: floorPlan("arms"),     latitude: 40.430975, longitude: -86.914995),
    ]
